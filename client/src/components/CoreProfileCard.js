  ...
  return (
    <>
      <div className='flex flex-col border-2 border-gfgmaincolor shadow-2xl hover:shadow-black   md:w-1/5 w-full h-min hover:bg-right-bottom cursor-pointer transition ease-in-out delay-20 
        ...
        rounded-3xl'>
        <div className='hover:from-gfgmaincolor/40 hover:to-gfgmaincolor bg-gradient-to-r from-gfgmaincolor  to-gfgmaincolor/40 border-2 border-white relative h-28 flex justify-center rounded-t-3xl'>
